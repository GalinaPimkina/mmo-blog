...
Он может принять его или отклонить. В зависимости от его действий, на сайте будет выведена информация о статусе отклика как для автора объявления, так и для других пользователей.
